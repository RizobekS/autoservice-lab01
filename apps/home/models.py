...
class Slide(SortableMixin):
    static_text = models.CharField('Статичный текст', max_length=200)
    animated_text = models.CharField('Анимированный текст', max_length=200)
    ...
    background_image = models.ImageField('Фоновое изображение', upload_to='slides', null=True, blank=True)
