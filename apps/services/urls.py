...
from .views import SectionView, ProductView, SparePartsView, SubmitCallRequestView, RedirectOldSectionCarUrls
from ..cars.utils.urlconverters import CarPathConverter, OldCarPathConverter
...
urlpatterns = [
    path('<section_filter:section_url>/<old_car_converter:urls>/', RedirectOldSectionCarUrls.as_view(), name='section_redirect_car_url'),
    path('<product_filter:product_url>/<old_car_converter:urls>/', RedirectOldSectionCarUrls.as_view(), name='product_redirect_car_url'),
