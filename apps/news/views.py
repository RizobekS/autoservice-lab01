...
class ArticleView(DetailView, FormView, PageTitleMixin, LatestArticlesMixin, CommentsMixin):
    model = Article
    slug_field = 'url'
    ...
    initial_breadcrumbs = [Breadcrumb('Блог', reverse_lazy('home:index'))]  # TODO: Сменить URL на другую страницу
